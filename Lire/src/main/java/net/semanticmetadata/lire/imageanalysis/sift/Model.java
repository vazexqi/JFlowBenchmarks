...
/**
 * Abstract class for arbitrary geometric transformation models to be applied to points in
 * n-dimensional space.
 * <p/>
 * Provides methods for generic optimization and model extraction algorithms. Currently, RANSAC and
 * Monte-Carlo minimization implemented. Needs revision...
 * <p/>
 * TODO A model is planned to be a generic transformation pipeline to be applied to images, volumes
 * or arbitrary sets of n-dimensional points. E.g. lens transformation of camera images, pose and
 * location of mosaic tiles, non-rigid bending of confocal stacks etc.
 * <p/>
 * License: GPL
 * <p/>
 ...
 * 02111-1307, USA.
 * <p/>
 * NOTE: The SIFT-method is protected by U.S. Patent 6,711,293: "Method and apparatus for
 * identifying scale invariant features in an image and use of same for locating an object in an
 * image" by the University of British Columbia. That is, for commercial applications the permission
...
abstract public class Model {
    ...
    /**
     * fit the model to a minimal set of point correpondences estimates a model to transform
     * match.p2.local to match.p1.world
     * 
     ...
     * @param scale gives a multiplicative factor to each dimensional distance (scales the amount of
     *            shaking)
