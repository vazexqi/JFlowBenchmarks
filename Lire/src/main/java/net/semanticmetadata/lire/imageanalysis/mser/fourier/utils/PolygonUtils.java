...
/**
 * Created by IntelliJ IDEA. User: Shotty Date: 10.01.11 Time: 04:11 To change this template use
 * File | Settings | File Templates.
 */
public class PolygonUtils {
    /**
     * METHODS TO CALCULATE THE AREA AND CENTROID OF A POLYGON INSERT THEM INTO THE CORRESPONDING
     * CLASS *
     */
