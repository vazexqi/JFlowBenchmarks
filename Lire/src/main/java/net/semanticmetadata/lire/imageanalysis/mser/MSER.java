...
/**
 * Calculates Maximally stable extremal regions Algorithm based on Linear Time Maximally Stable
 * Extremal Regions by David Nist_r and Henrik Stew_nius (2008)
 * <p/>
 * User: Shotty Date: 28.06.2010 Time: 09:48:00
 */
public class MSER {
...
//        System.out.println("ERS found: " + ers.size());
        ...
        for (int i= 0; i < ers.size(); i++) {
            ...
            while (true) {
                ...
                /**
                 * Region is R-delta of actRegion VAL (r0) <= VAL (ri) - DELTA < VAL (r1)
                 */
                ...
                /**
                 * actRegion is R+delta of region VAL(ri) <= VAL(x0) + DELTA < VAL(ri + 1)
                 */
                 ...
                 * 
                 * VAL(r1) <= VAL(ri) - DELTA --> No bottom can be found anymore VAL(ri) > VAL(r0) +
                 * DELTA --> no top can be found anymore
                 */
...
//            System.out.println("secondComp.greyLevel:" + componentStack.peek().getGreyLevel());
     ...
     * @return cyclic translated matrix, e.g. cycltrans([1 2 3; 4 5 6; 7 8 9], 1,1) = [5 6 4; 8 9 7
     *         ; 2 3 1]
     */
