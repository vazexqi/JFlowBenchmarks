...
/**
 * NaiveAutoCorrelogramExtraction is an implementation of the naice approach to extract
 * auto-correlogram feature vector from images (Full Neighborhood is used). It is based on Huang et
 * al paper, "Image Indexing Using Color Correlograms", CVPR1997. J Huang, S. R Kumar, M. Mitra, W.
 * Zhu, R. Zabih
 * <p/>
 * This method is very similar to MLux FullNeighbourhood algorithm, but doesn't acummulate the
 * feature frequence over different distances and uses the standard normalization.
 * 
