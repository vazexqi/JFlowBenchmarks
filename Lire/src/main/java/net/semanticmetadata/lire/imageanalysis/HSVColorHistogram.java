...
/**
 * This class provides a simple color histogram for content based image retrieval. Number of bins is
 * configurable, histogram is normalized to 8 bit per bin (0-255). <br>
...
//            return qH * 7 + qS;
    ...
    /**
     * Jeffrey Divergence or Jensen-Shannon divergence (JSD) from Deselaers, T.; Keysers, D. & Ney,
     * H. Features for image retrieval: an experimental comparison Inf. Retr., Kluwer Academic
     * Publishers, 2008, 11, 77-107
     * 
     * @param h1
     * @param h2
     * @return
