...
/**
 * Created by IntelliJ IDEA. User: Shotty Date: 10.01.11 Time: 05:00 To change this template use
...
//        Assert.assertTrue("p is 0 !!! Major BUG!", p != 0);
    ...
    /**
     * return a float array with the invariants. The invariants go from negative to positive
     * 
