 ...
 * using Inverted Files" Date: 14.05.2009 Time: 14:22:03
 * 
...
public class MetricSpacesInvertedListIndexing {
     ...
     * creates ordered lists of reference object positions for each data item in the index with
     * given feature. Finally a new index (name "<indexPath>-ms") is created where all the original
    ...
    /**
     * Returns a reader for the index consisting the documents with the approximate search
     * information.
     * 
     * @param indexPath
     * @return
