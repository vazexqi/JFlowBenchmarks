...
public class FastMap implements Runnable {
    ...
    /**
     * Creates a new FastMap which uses attached FastmapDistanceMatrix and projects to a space with
     * given dimensions
     * 
    ...
    /**
     * Finds the pivots where the other points are interpolated in between. This method is
     * definitely issue to tuning. Currently a greedy approach is implemented.
     * 
     * @param k
     */
