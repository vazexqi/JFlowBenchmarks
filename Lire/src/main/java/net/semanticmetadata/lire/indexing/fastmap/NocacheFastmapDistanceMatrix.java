...
/**
 * Simulated distance matrix. No internal object is used to create the matrix, but the distance
 * between objects is computed online. Suitable for use with FastMap, but not with HAC, K-Means or
 * alike. Date: 16.09.2008 Time: 12:56:13
 * 
