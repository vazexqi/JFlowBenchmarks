...
/**
 * Date: 07.02.2005 Time: 22:10:54
 * 
 * @author Mathias Lux, mathias@juggle.at
 */
public interface SimilarityMatrix {
    /**
     * Calculates the distance between objects using the distance function for k = 0, using . If it
     * has not been computed previously it is computed and stored now.
     * 
    ...
    /**
     * Calculates the Similarity between objects using the Similarity function for k = 0, using . If
     * it has not been computed previously it is computed and stored now.
     * 
