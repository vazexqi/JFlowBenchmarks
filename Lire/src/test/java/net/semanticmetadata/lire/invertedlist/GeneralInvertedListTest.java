 ...
 *//**
 * Returns the current document number matching the query. Initially invalid, until
 ...
 *//**
 * Skips to the first match beyond the current whose document number is greater than or equal to a
 * given target. <br>
 ...
 * When this method is used, the {@link #next()} method and the {@link #score(HitCollector)} method
 * should not be used.
 * 
