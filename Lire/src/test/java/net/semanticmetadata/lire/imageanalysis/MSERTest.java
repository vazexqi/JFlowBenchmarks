...
/**
 * Created by IntelliJ IDEA. User: mlux Date: 02.05.2011 Time: 10:42:00 To change this template use
    ...
    public void testMSERExtraction() throws IOException {
        ...
        for (int i= 0; i < binaryValues.length; i++) {
            ...
            for (int j= 0; j < feat.descriptor.length; j++) {
                if (Float.isNaN(feat.descriptor[j]))
                    System.out.println("feat " + i + " = " + feat);
                break;
            }
        }
    }
