...
public class Processor {
     ...
     * 
     * @param overwrite If true, make new Lucene index. If false, leave existing data.
     */
    ...
    /**
     * Reads all available records from the data sources and processes them in batches, notifying
     * the listeners throughout.
     */
    ...
    /**
     * Deduplicates a newly arrived batch of records. The records may have been seen before.
     */
...
//                comparing+= System.currentTimeMillis() - start;
    ...
    /*
     * The ORIGINAL parallelization by Duke using threads. There is a data race
     * in the no.priv.garshol.duke.Processor.match(Record, boolean) method
     * because it increments the values of searching and comparing without
     * any protection. A solution would be to use AtomicIntegers.
     */
    ...
    /**
     * Retrieve new records from data sources, and match them to previously indexed records. This
     * method does <em>not</em> index the new records. With this method, <em>all</em> matches above
    ...
    /**
     * Retrieve new records from data sources, and match them to previously indexed records. This
     * method does <em>not</em> index the new records.
     * 
     * @param matchall If true, all matching records are accepted. If false, only the single best
     *            match is accepted.
     * @since 0.5
     */
    ...
    /**
     * Index all new records from the given data sources. This method does <em>not</em> do any
     * matching.
     * 
     * @since 0.4
     */
    ...
    /**
     * Compares two records and returns the probability that they represent the same real-world
     * entity.
     */
    ...
    /**
     * Sorts properties so that the properties with the lowest low probabilities come first.
     */
    ...
    /**
     * The thread that actually runs parallell matching. It holds the thread's share of the current
     * batch.
     */
