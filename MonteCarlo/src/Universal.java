...
/**
 * Base class for all non-trivial classes. Used as a centralised repository for all the
 * functionalities which all classes written by me, which will be of use.
 * 
 * @author H W Yau
...
public class Universal {
     ...
     * Set method for private instance variable <code>DEBUG</code>.
     * 
     * @param UNIVERSAL_DEBUG the value to set for the instance variable
