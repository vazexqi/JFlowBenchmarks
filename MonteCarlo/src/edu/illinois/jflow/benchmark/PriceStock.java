...
/**
 * Class to do the work in the Application demonstrator, in particular the pricing of the stock path
 * generated by Monte Carlo. The run method will generate a single sequence with the required
 * statistics, estimate its volatility, expected return rate and final stock price value.
 * 
 * @author H W Yau
...
public class PriceStock extends Universal {
    ...
    // ------------------------------------------------------------------------
    /**
     * Method which is passed in the initialisation data common to all tasks, and then unpacks them
     * for use by this object.
     * 
    ...
    /**
     * Method which is passed in the data representing each task, which then unpacks it for use by
     * this object.
     * 
    ...
    /**
     * The business end. Invokes the necessary computation routine, for a a given task.
     */
    public void run() {
