...
public class ToInitAllTasks {
    ...
    /**
     * Constructor, for initialisation data which are common to all computation tasks.
     * 
     ...
     * @param pathStartValue The stock price value to use at the start of each Monte Carlo
     *            simulation path.
     */
    ...
    /**
     * Another constructor, slightly easier to use by having slightly fewer arguments. Makes use of
     * the "ReturnPath" object to accomplish this.
     * 
     * @param obj Object used to define the instance variables which should be carried over to this
     *            object.
     * @param nTimeSteps The number of time steps which the Monte Carlo generator should make.
     * @param pathStartValue The stock price value to use at the start of each Monte Carlo
     *            simulation path.
